...
const Footer = () => {
  return (
    <Wrapper>
      <div class="overlap-3">
        <img class="logo-2" src={GlobalLogo} alt="" />
        <div class="text-wrapper-1">CHRONIC TEMPERATURE MACHINE</div>
        <div class="text-wrapper-2">CHRONIC TEMPERATURE MACHINE</div>
        <div class="text-wrapper-3">chronic.temp.machine</div>
        <div class="text-wrapper-4">climate.change@rmit.edu.vn</div>
        <img class="icon-facebook" src={iconfacebook} alt="iconfacebook" />
        <img class="icon-instagram" src={iconinstagram} alt="iconinstagram" />
        <img class="icon-mail" src={iconmail} alt="iconmail" />
        <iframe
          className="image-1"
          title="RMIT map"
